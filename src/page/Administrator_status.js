...
import Insert_admin from "../Management/Insert_admin_status";
import Update_admin from "../Management/Update-Admin_status";
            ...
            <div className="container-content">
                <div className="container-full">
                    ...
                    <div className="group-option-table">
                        ...
                        <div className="btn-float-left"><button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Insert_admin"><i class="bi bi-cloud-plus-fill"></i> ເພີມຂໍ້ມູນ</button></div>
                    </div> &nbsp;
